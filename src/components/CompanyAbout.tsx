        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-6 sm:gap-8 lg:gap-12 items-center justify-center">
              ...
              <div className="flex-1 order-2 lg:order-1 px-4 sm:px-6 lg:px-8 xl:px-12">
                <p
                  ...
                  className="mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed text-gray-700"
                >
                  Our team consists of trained professionals and erudite experts
                  who have in-depth knowledge of the regions and the way
                  Buddhism connects to each of them. We ensure to arrange for
                  luxurious and hassle-free travel to Buddhist pilgrimage sites,
                  only with the motto to bring you closer to yourself.
                </p>
                <p
                  ref={(el) => setContentRef(el, 3)}
                  className="mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed text-gray-700"
                >
                  We are a people's organization, which is why you can rely on
                  us for your comfort, quality of services and exciting travel
                  itinerary. Buddhist Tours grows every moment with the trust of
                  the people. We believe in building relationships with you that
                  last for a lifetime, just like the enthralling and memorable
                  experience of the travel that goes beyond words.
                </p>
              </div>
              {/* Image */}
              <div
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p
              ...
              className="mb-4 sm:mb-6 text-sm sm:text-base lg:text-lg leading-relaxed text-gray-700"
            >
              Our extensive network of representatives works 24*7 to provide you
              with a seamless pilgrimage to Buddhist destinations across the
              Indo Gangetic plains. Seeded with the foundation of providing
              personalized services on your journey to spirituality, Buddhist
              Tours offers one of the most competitive rates. Be it hotels or
              other supplies, we offer the best in class services backed by
              unparalleled rates.
            </p>
            ...
            >
              ...
              high-spirited Buddha, in its very essence, while you renaissance
              through each moment.
            </p>
            ...
            >
              <div className="inline-block relative rounded-lg p-4 overflow-hidden">
                ...
                <div className="relative z-10 space-y-1">
                  ...
                  <p className="text-sm sm:text-base lg:text-lg font-semibold text-pri-brown">
                    For Buddhist Tour
                  </p>
                </div>
              </div>
