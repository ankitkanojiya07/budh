...
const Journey = () => {
  const data = {
    journeyData: {
      ...
      mainHeadingL1: "Path to Inner",
      mainHeadingL2: "Harmony",
  ...
  return (
    <div className={"bg-dim-pink w-full font-cormorant p-4 py-24"}>
      <div className="w-full px-4 sm:px-6 overflow-hidden">
        <div className="mx-auto max-w-7xl mb-8 px-2 sm:px-4 lg:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-orange-700 via-amber-600 to-orange-800 bg-clip-text text-transparent font-serif">
            Discover Your Path
          </h2>
          <p className="">
      ...
      <section
        className={
          "w-full grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 justify-items-center max-w-6xl mx-auto"
        }
      >
        {/* Journey Section */}
