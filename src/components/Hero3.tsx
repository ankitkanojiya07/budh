      ...
      <div className="relative pt-30 min-h-screen z-10 max-w-[1400px] max-sm:px-4 md:px-5 mx-auto flex flex-col justify-center h-full ">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4 w-full">
            <div>
              <div className="flex  text-white gap-1.5 font-lora uppercase font-medium max-sm:text-center">
                <p>Sanctuaries</p>
                <p>|</p>
                <p>Plains</p>
                <p>|</p>
            ...
            <div>
              <h1 className="text-white text-6xl font-lora max-w-[600px] max-sm:text-5xl max-sm:text-center leading-14 font-semibold">
                Find Peace Where the Buddha Walked
              </h1>
            </div>
          </div>

          {/* popular tour bar */}
          <div className="flex flex-col max-sm:w-full max-w-xl w-full gap-2.5 items-start justify-start relative">
