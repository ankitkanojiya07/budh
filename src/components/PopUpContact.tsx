        ...
        <div className="fixed inset-0  flex items-center justify-center z-50 p-4">
            <div className="bg-[#F5F5DC] rounded-lg shadow-2xl max-w-md w-full relative">
                ...
                <div className="bg-[#8B4513] text-white text-center py-2 px-4 rounded-t-lg">
                    <span className="font-bold text-sm uppercase tracking-wide">Free Consultation</span>
                </div>
                ...
                <div className="p-6">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600 mb-2">
                            <span className="text-[#8B4513]">◆</span> Premium Travel Experiences Guaranteed!
                        </p>
                        <a href="/privacy" className="text-sm text-[#8B4513] underline hover:text-[#654321]">
                            Privacy policy
                        </a>
                    </div>
                </div>
